...
namespace EJERCICIO_CALCULO_SUELDO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // el Cálculo de AFP e ISSS
            double afp = sueldo * 6.25 / 100;
            double isss = sueldo * 3 / 100;
            double isr = 0;

            // Aqui Resto de la AFP al salario bruto
            sueldo -= afp;

            // Este es el Bucle para calcular el ISR
            for (int i = 0; i < 4; i++)
            {
            ...
            // Imprime el resultado que nos da
